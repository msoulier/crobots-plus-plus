function(add_shader TARGET PATH)
    ...
    set(HLSL ${CMAKE_SOURCE_DIR}/lib/SDLx_gpu/${DIRECTORY}/${NAME})
    set(SPV ${CMAKE_SOURCE_DIR}/lib/SDLx_gpu/${DIRECTORY}/bin/${NAME}.spv)
    set(DXIL ${CMAKE_SOURCE_DIR}/lib/SDLx_gpu/${DIRECTORY}/bin/${NAME}.dxil)
    set(MSL ${CMAKE_SOURCE_DIR}/lib/SDLx_gpu/${DIRECTORY}/bin/${NAME}.msl)
    set(JSON ${CMAKE_SOURCE_DIR}/lib/SDLx_gpu/${DIRECTORY}/bin/${NAME}.json)
    if(MSVC)
